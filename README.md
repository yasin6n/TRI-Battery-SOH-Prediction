...
- **Model Deployment**  
  Explore lightweight deployment options (ONNX export + simple inference script) for potential edge/BMS use. A basic interactive demo (Streamlit/Gradio) plan for future.
